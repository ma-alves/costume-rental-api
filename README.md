# Costume Rental API
It is a RESTful API for a costume rental service using Python, FastAPI and PostgreSQL as its core technologies, as well as JWT for authentication, Pytest for testing and a rate limiter to prevent abuse.
