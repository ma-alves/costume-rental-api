...
@router.get('/payment-intent/{payment_intent_id}', response_model=PaymentRetrieveResponse)
async def retrieve_payment_intent(
    current_user: CurrentUser,
    payment_intent_id: str,
    session: Session,
):
    return await payment_service.retrieve_payment_intent(session, current_user, payment_intent_id)
...
async def delete_saved_card(
    ...
    return await payment_service.delete_saved_card(session, current_user, payment_method_id)